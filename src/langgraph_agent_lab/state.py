...
class AgentState(TypedDict, total=False):
    """Lean, serializable LangGraph state.

    Scalar and object fields use LangGraph's default overwrite behavior. Audit and
    history lists use the ``add`` reducer so node updates are append-only.
    """
